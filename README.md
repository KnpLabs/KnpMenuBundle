...
This bundle is maintained by the following people (alphabetically sorted):
...
the [Symfony community](https://github.com/KnpLabs/KnpMenuBundle/graphs/contributors).
